...
public class SMSLoginJdbcDaoImpl extends JdbcDaoImpl
{
	...
	private static final String USERS_BY_MOBILE_QUERY = "select username,password,enabled,saltValue from users where mobile = ?";
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException
	{
		...
		if (users.size() == 0)
		{
			...
			{ username }, "User mobile {0} not found"));
		}
	...
	@Override
	protected List loadUsersByUsername(String mobile)
	{
		return getJdbcTemplate().query(USERS_BY_MOBILE_QUERY, new String[]
		{ mobile }, new RowMapper<Object>()
		{
