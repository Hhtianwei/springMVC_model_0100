...
public class MyJdbcTokenStore implements TokenStore
{
	...
	public void storeAccessToken(OAuth2AccessToken token, OAuth2Authentication authentication)
	{
		...
		{ extractTokenKey(token.getValue()), new SqlLobValue(serializeAccessToken(token)),
	...
	public OAuth2AccessToken readAccessToken(String tokenValue)
	{
		...
		catch (EmptyResultDataAccessException e)
		{
			...
			{
				LOG.info("1 Failed to find access token for token " + tokenValue);
			}
		}
		catch (IllegalArgumentException e)
		{
	...
	{
		System.out.println("removeAccessToken 200.....");
		removeAccessToken(token.getValue());
	}

	public void removeAccessToken(String tokenValue)
	{
		System.out.println("removeAccessToken 205.....");
	...
	public OAuth2Authentication readAuthentication(String token)
	{
		...
		catch (EmptyResultDataAccessException e)
		{
			if (LOG.isInfoEnabled())
			{
				LOG.info("2 Failed to find access token for token " + token);
			}
		}
		catch (IllegalArgumentException e)
		{
	...
	{
		jdbcTemplate.update(insertRefreshTokenSql, new Object[]
		{ extractTokenKey(refreshToken.getValue()), new SqlLobValue(serializeRefreshToken(refreshToken)),
	...
	{
		System.out.println("removeRefreshToken 3333333333.....");
	...
	public OAuth2Authentication readAuthenticationForRefreshToken(String value)
	{
		...
		catch (EmptyResultDataAccessException e)
		{
			if (LOG.isInfoEnabled())
			{
				LOG.info("3 Failed to find access token for token " + value);
			}
		}
		catch (IllegalArgumentException e)
		{
	...
	{
		System.out.println("removeAccessTokenUsingRefreshToken 11111111111.....");
		removeAccessTokenUsingRefreshToken(refreshToken.getValue());
	}

	public void removeAccessTokenUsingRefreshToken(String refreshToken)
	{
		System.out.println("removeAccessTokenUsingRefreshToken 2222222222.....");
		jdbcTemplate.update(deleteAccessTokenFromRefreshTokenSql, new Object[]
